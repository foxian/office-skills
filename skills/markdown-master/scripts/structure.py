...
_NUMBER_PREFIX = re.compile(r"^(?:[\d零一二三四五六七八九十百千万]+(?:\.[\d零一二三四五六七八九十百千万]+)+\s+|第[\d零一二三四五六七八九十百千万]+章\s*|[\d零一二三四五六七八九十百千万]+[、，.．]\s*|[\d零一二三四五六七八九十百千万]+\s+|\([\d零一二三四五六七八九十百千万]+\)\s*|（[\d零一二三四五六七八九十百千万]+）\s*|【[\d零一二三四五六七八九十百千万]+】\s*|[IVXLCDMivxlcdm]+\.\s+|[A-Za-z]\.\s+|\s+)")
